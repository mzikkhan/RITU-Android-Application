...
public class Submission3 extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.goTaskBtn:
                ...
                break;
            case R.id.submitBtn:
                String url = url3.getText().toString().trim();
                player.setTask3(url);
                player.setPoints(150);
                intent=new Intent(getApplicationContext(),Task4.class);
                startActivity(intent);
                break;
