...
public class Submission5 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_submission5);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.goTaskBtn:
                ...
                break;
            case R.id.submitBtn:
                String url = url5.getText().toString().trim();
                player.setTask5(url);
                player.setPoints(250);
                intent=new Intent(getApplicationContext(),Ending.class);
                startActivity(intent);
                break;
